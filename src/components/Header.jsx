...
function Header() {
    return (
        <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full' style={{ backgroundImage: "url('/header_img.png')" }} id='Header'>
            <Navbar />
            <motion.div 
            ...
            className='container text-center mx-auto py-4 px-6 md:px20 lg:px-32 text-white'>
                <h2 className='text-5xl sm:text-6xl md:text[82px] inline-block max-w-3xl font-semibold pt-20 '>Explore Your Dream Home</h2>
